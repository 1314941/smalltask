...
public class FileDemo {
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		// 保存匹配的日志信息到文件中
		// logService.saveMatchedLog(matchLogs);
		logService.saveAndAppendMatchedLog(matchLogs);
		// 保存匹配的日志信息到数据库中
		...
		MatchedTransport mt1 = new MatchedTransport(
		...
		MatchedTransport mt2 = new MatchedTransport(

...
public class DBDemo {
	public static void main(String[] args) {
		...
		matchLogs.add(
				new MatchedLogRec(new LogRec(1001, new Date(), "青島", DataBase.GATHER, "zhangsan", "192.168.1.1", 1),
						new LogRec(1002, new Date(), "青島", DataBase.GATHER, "zhangsan", "192.168.1.1", 0)));
		matchLogs.add(new MatchedLogRec(new LogRec(1003, new Date(), "北京", DataBase.GATHER, "lisi", "192.168.1.6", 1),
				new LogRec(1004, new Date(), "北京", DataBase.GATHER, "lisi", "192.168.1.6", 0)));
		matchLogs
				.add(new MatchedLogRec(new LogRec(1005, new Date(), "济南", DataBase.GATHER, "wangwu", "192.168.1.89", 1),
		...
		matchTrans.add(
				new MatchedTransport(new Transport(2001, new Date(), "青島", DataBase.GATHER, "zhangsan", "zhaokel", 1),
		...
		matchTrans.add(new MatchedTransport(new Transport(2004, new Date(), "青島", DataBase.GATHER, "maliu", "w", 1),
